...
const systemPrompts: Record<string, string> = {
  ...
  suggest_premortems: `You are a premortem analysis expert inspired by Gary Klein's premortem technique. Imagine this decision has already failed. Identify 3-5 specific, concrete reasons why it could fail. Consider risks the user may have overlooked. Be specific and actionable. For each risk, rate frequency (likelihood) as one of: "very unlikely", "unlikely", "possible", "likely", "very likely". Rate severity (impact) as one of: "negligible", "minor", "moderate", "significant", "severe". Be realistic and varied — not everything is "possible" / "moderate".`,
